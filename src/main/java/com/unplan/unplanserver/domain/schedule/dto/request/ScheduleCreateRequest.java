...
public class ScheduleCreateRequest {
    ...
    @Schema(description = "개인 태그 이름 목록 (선택, 최대 10개, 각 50자 이내). 같은 이름은 대소문자 무시하고 재사용됨", example = "[\"자기계발\", \"건강\"]")
    @Size(max = 10, message = "개인 태그는 최대 10개까지 등록할 수 있습니다")
    private List<@Size(max = 50, message = "태그 이름은 50자를 초과할 수 없습니다") String> personalTags;
