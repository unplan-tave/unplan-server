...
public enum ErrorCode {
    ...
    KAKAO_CONNECTION_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT, "KAKAO_CONNECTION_TIMEOUT", "카카오 서버에 연결할 수 없습니다."),
    KAKAO_RESPONSE_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT, "KAKAO_RESPONSE_TIMEOUT", "카카오 서버 응답 시간이 초과되었습니다."),
    ...
    GOOGLE_CONNECTION_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT, "GOOGLE_CONNECTION_TIMEOUT", "구글 서버에 연결할 수 없습니다."),
    GOOGLE_RESPONSE_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT, "GOOGLE_RESPONSE_TIMEOUT", "구글 서버 응답 시간이 초과되었습니다."),
    ...
    TIME_RANGE_OVERLAP(HttpStatus.CONFLICT, "TIME_RANGE_OVERLAP", "입력한 시간대가 기존 시간대와 겹칩니다."),
